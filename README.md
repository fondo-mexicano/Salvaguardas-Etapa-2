...
Creación de un sistema de alertas visuales basado en umbrales condicionales y semaforización (códigos de color) para destacar de manera inmediata los registros que requieren acciones prioritarias.  
